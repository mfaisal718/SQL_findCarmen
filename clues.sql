...
country 
WHERE 
region = 'Souther Europe' 
ORDER BY 
population ASC;

 answer= VAT - 1000 population 
...
answer: 2 cities: Serravalle & San Marino
going to Serravalle?
...
Carmen's headed for Santa Monica, USA California
